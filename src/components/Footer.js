  ...
  return (
    <div className="relative justify-center items-center  ">
      ...
      <div className="flex top-[13rem]  h-[435px] pb-4 lg:pb-0   bg-[#0529BB] lg:bg-inherit  justify-center lg:ml-[10rem] items-start flex-col absolute lg:top-0 ">
        ...
        <div className="flex lg:flex-row flex-col lg:flex-wrap  md:flex-wrap  md:flex-row gap-x-[4rem]">
          ...
          <div className="flex  lg:w-[252px] md:w-[400px] my-2 lg:my-0 justify-evenly text-white font-poppins">
            <div className="  ">
          ...
          <div className="flex w-[260px] md:w-[260px] lg:w-[260px] sm:w-[260px] lg:ml-10 mt-4 ml-14 md:ml-0 mr-10  relative items-center cursor-pointer h-[44px] rounded-lg">
            <form className=" ">
              {message === "" ? (
      ...
      <div className="flex text-white items-center gap-x-6 mt-4 w-full   opacity-80 absolute lg:w-[100%] md:w-[100%] top-[36rem] lg:top-[36rem] justify-between">
        ...
        <div className="flex items-center w-full gap-x-0  justify-between   lg:gap-x-[8px]">
