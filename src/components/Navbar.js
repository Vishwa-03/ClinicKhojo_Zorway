    ...
    <div >
      <div className=" hidden lg:flex xl:w-[1200px] lg:w-[1000.66px] sm:w-[600px] mx-auto  lg:flex-row rounded-lg lg:gap-[5rem] xl:gap-[8rem] bg-white h-[5.5rem] lg:h-[4.5rem] mt-[3rem] px-[1.25rem] py-[1.25rem] items-center md:flex md:w-[750px] md:h-[4.3rem] md:flex-row md:items-center md:gap-[2rem] sm:flex sm:px-1 sm:h-[4rem] sm:flex-row sm:items-center sm:gap-x-2  ">
        ...
        <div className="flex items-center justify-center mb-4 lg:mb-0 md:mb-0 sm:mb-0 xl:mb-0">
          <img
            src={Logo}
            className="lg:w-[121.66px] lg:h-[100px] sm:w-[65px]  sm:h-[70px] h-[100px] mt-0 w-[100px]  lg:mt-3  "
            alt="Logo"
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row md:flex-row sm:flex-row sm:gap-x-3 md:gap-x-10
         w-full lg:w-[100%] ">
          <ul className="flex items-center xl:gap-[38px] sm:gap-x-[15px]  md:mb-0 lg:gap-[28px] md:gap-x-3 mb-4 sm:mb-0 lg:mb-0">
            {/* Menu items */}
          ...
          <div className="flex flex-col sm:flex-row   xl:gap-x-6 lg:gap-x-4 lg:flex-row w-full lg:w-[380px] xl:ml-auto xl:w-[410px] md:items-center lg:ml-auto md:w-[300px] md:flex-row md:gap-x-4 sm:items-center sm:gap-x-3 ">
            ...
            <div className="flex bg-white md:h-[50px] md:items-center items-center border-2 rounded-lg gap-[10px] border-red-500 md:mb-1 py-[8px] px-[15px] md:px-[10px] hover:scale-105 transition-all sm:w-[120px] sm:h-[47px] md:gap-x-1 md:w-[150px] duration-300 cursor-pointer sm:px-0 sm:justify-evenly">
              <button className="text-[#FA0808] text-[20px] md:text-[17.5px] sm:text-[16.5px] font-poppins">
                <Link to="#Contact" smooth>
                  Contact us
                </Link>
              </button>
              <MdPermContactCalendar className="" size={20} color="red" />
            </div>
          </div>
        </div>
      </div>
      ...
      <nav class="bg-white  lg:hidden md:hidden sm:hidden h-[4.5rem]  border-gray-200 ">
        <div class="flex  justify-between items-center mx-auto max-w-screen-xl p-1">
          <a href="" class="flex items-center -space-x-[4px] rtl:space-x-reverse">
            <img src={Logo} className="h-[60px] w-[60px] " alt="Flowbite Logo" />
      ...
      <nav class="bg-gray-50 lg:hidden md:hidden sm:hidden dark:bg-gray-700">
        <div class="max-w-screen-xl px-4 py-3 mx-auto">
          <div class="flex items-center justify-between mr-1">
            <ul class="flex flex-row justify-evenly font-medium mt-0 space-x-4 rtl:space-x-reverse text-sm">
              <li>
                <a
                  href="#"
