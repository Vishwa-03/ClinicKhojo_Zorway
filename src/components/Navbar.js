...
const Navbar = () => {
  ...
  return (
    <div>
      <div className=" hidden lg:flex lg:w-[1152.66px] sm:w-[400px] mx-auto  lg:flex-row rounded-lg lg:gap-[8.5rem] bg-white h-[5.5rem] mt-[3rem] px-[1.25rem] py-[1.25rem] items-center">
        {/* Logo */}
      ...
      <nav class="bg-gray-50 lg:hidden dark:bg-gray-700">
        <div class="max-w-screen-xl px-4 py-3 mx-auto">
          <div class="flex items-center justify-between">
            <ul class="flex flex-row font-medium mt-0 space-x-7 rtl:space-x-reverse text-sm">
              <li>
                <a
                  href="#"
            ...
            <div className="flex bg-white items-center border-2 rounded-lg gap-[5px] border-red-500  px-[8px] hover:scale-105 transition-all duration-300 cursor-pointer py-[4px]">
