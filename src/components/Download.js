...
const Download = () => {
  return (
    <div
      id="Download"
      className="relative h-[12rem] lg:h-[400.47px] md:h-[300px] -mt-[3rem]  w-[1300.73px]"
    >
      <img
        src={injection}
        className="z-10 absolute top-[2.5rem] h-[140px]  lg:top-0 left-3 lg:left-60  lg:h-full lg:w-full md:h-full md:w-full md:top-0 md:-left-20 sm:h-[140%] sm:w-full sm:-top-[8rem] sm:-left-[10rem] "
      />
