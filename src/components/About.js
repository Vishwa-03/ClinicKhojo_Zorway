...
const About = () => {
  return (
    <div id="AboutUs" className="w-full  relative lg:mt-[4rem] h-[53rem] mb-10  lg:h-[754px] overflow-hidden  ">
      <div className="z-100  absolute   flex flex-row w-full   justify-evenly">
        ...
        <div className="">
          <img className="h-[45.5rem] w-[44.5rem] hidden lg:flex " src={prescriptionImage} />
        </div>
      </div>
      <div className="">
        <img
          className="-z-10  -top-48 lg:right-0 w-full h-[754px] absolute"
          src={backgroundImg}
        />
      </div>
      <img
