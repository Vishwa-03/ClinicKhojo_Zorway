          ...
          <div className="h-[32rem] ">
            <div className="flex flex-col mt-[3rem] md:mt-2  h-[50rem]  bg-[#E1E0E0] lg:bg-inherit gap-0  lg:gap-[2rem] lg:ml-[6rem] lg:w-[660px] md:h-[300px] sm:h-[400px] w-full px-4 lg:px-0 ">
              <div className="flex  gap-x-4">
                <p className="text-justify font-poppins  leading-[20.6px] lg:leading-[25px] text-[12px] lg:text-[16px] w-1/2 md:text-[16px] sm:text-[16px]">
                ...
                <p className="text-justify text-[12px] font-poppins  lg:leading-[25px] leading-[20.6px] lg:text-[16px] w-1/2 md:text-[16px] sm:text-[16px]">
