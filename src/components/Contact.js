...
const ContactUs = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex mt-10 lg:mt-2 mr-10  border-l-2 z-20  border-[#7C7B7B] flex-col w-[100%] items-start">
          ...
          <div className="flex flex-col    mt-[5rem] lg:mt-0">
            <div className=" flex  flex-col lg:gap-y-[1.5rem] gap-y-[1rem] w-full h-[10rem]   lg:w-[14rem] lg:h-[14rem]">
              ...
              <div className="flex  items-center  justify-evenly  font-poppins w-[14rem]">
                <IoLocationSharp className="ml-2" color="#535252" size={35} />
      ...
      <img
        className=" absolute -top-16 mr-8 -z-40 flex lg:absolute   lg:-z-0 lg:-top-[10rem]   overflow-hidden left-1 scale-105"
        src={backgroundImg}
        color=""
      />
    </div>
